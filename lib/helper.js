...
var retryPromise = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(fn, attempts, backoff, authClientId) {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 12:
                        ...
                        eventLog.emit('Verification Attempt #' + backoff.attempts + ', retrying in ' + duration + 'ms: ' + _context.t0.message, authClientId);
                        _context.next = 17;
                        return Promise.delay(duration);

                    case 17:
                        return _context.abrupt('return', retryPromise(fn, attempts, backoff, authClientId));
    ...
    return function retryPromise(_x, _x2, _x3, _x4) {
