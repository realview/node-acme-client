...
var AcmeClient = function () {
    ...
    (0, _createClass3.default)(AcmeClient, [{
                                        ...
                                        return _regenerator2.default.wrap(function _callee9$(_context9) {
                                            while (1) {
                                                switch (_context9.prev = _context9.next) {
                                                    case 0:
                                                        _context9.next = 2;
                                                        return verify[challenge.type](authz, challenge, keyAuthorization, authClientId);
        ...
        value: function () {
            ...
            function completeChallenge(_x14) {
        ...
        value: function () {
            ...
            function waitForValidStatus(_x15) {
        ...
        value: function () {
            ...
            function revokeCertificate(_x19) {
